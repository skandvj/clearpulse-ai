...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-[linear-gradient(135deg,#0f172a,#2563eb)] text-white shadow-[0_14px_32px_rgba(37,99,235,0.24)] hover:brightness-105",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-white/75 bg-white/72 text-slate-900 shadow-[0_10px_28px_rgba(15,23,42,0.05)] backdrop-blur-xl hover:bg-white hover:text-slate-950",
        secondary: "bg-slate-100/90 text-slate-900 hover:bg-slate-200/80",
